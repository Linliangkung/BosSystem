...
<div data-options="region:'center'">
	<form id="functionForm" method="post" action="${pageContext.request.contextPath }/functionAction_add.action">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>访问路径</td>
						<td><input type="text" name="pageResource"  /></td>
					</tr>
					<tr>
						<td>是否生成菜单</td>
						<td>
					...
					<tr>
						<td>父功能点</td>
						<td>
							<input name="parentFunction.id" class="easyui-combotree" data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath }/functionAction_listajax.action'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
